...
//Visit License Files
	#define E_RC_LICENSE_ERROR1				_HRESULT_TYPEDEF_(0xA816001AL)	// Use times for license is 0; license expired.
	#define E_RC_LICENSE_ERROR2				_HRESULT_TYPEDEF_(0xA816001BL)	// Total running time for license expired; license expired
	#define E_RC_LICENSE_ERROR3				_HRESULT_TYPEDEF_(0xA816001CL)	// Termination time for license expired; license expired
	#define E_RC_LICENSE_ERROR4				_HRESULT_TYPEDEF_(0xA816001DL)	// System time changed, invalid license
	#define E_RC_LICENSE_ERROR5				_HRESULT_TYPEDEF_(0xA816001EL)	// Creating the thread of visiting the license file failed.
