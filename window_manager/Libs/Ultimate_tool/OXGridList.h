...
#define EDIT_TYPE_STRING	0
#define EDIT_TYPE_COMBO		1
#define EDIT_TYPE_TIME		2
...
public:
	...
	virtual void SetEditable(BOOL bEdit = TRUE, int nColumn = -1, int EditType = EDIT_TYPE_STRING);
